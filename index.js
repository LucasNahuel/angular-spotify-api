 ...
 */
 ...
 app.get('/callback', function(req, res) {
   ...
   console.log("code retrieved"+req.query.code);
   console.log("state retrieved"+req.query.state);
   ...
   if (state === null ) {
     ...
     request.post(authOptions, function(error, response, body) {
       if (!error && response.statusCode === 200) {
         ...
         res.redirect(process.env.FRONT_URL+access_token+"/"+refresh_token+"/"+expiration_time);
...
app.get("/search", (req, res) =>{
  ...
  var options = {
    url: 'https://api.spotify.com/v1/search?q='+searchTerm+'&type='+type,
    headers: { 'Authorization': 'Bearer ' + access_token },
    json: true
  };
...
app.get('/getRelatedArtists', (req, res)=>{
